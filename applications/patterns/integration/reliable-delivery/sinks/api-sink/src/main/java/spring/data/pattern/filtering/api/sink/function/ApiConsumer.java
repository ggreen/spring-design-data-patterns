package spring.data.pattern.filtering.api.sink.function;
...
@Component
@Slf4j
public class ApiConsumer implements Consumer<Message<String>> {

    private final RestTemplate restTemplate;
    private final URI uri;

    @SneakyThrows
    public ApiConsumer(RestTemplate restTemplate, @Value("${api.url}") String uri) {
